    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">Party-Up.be</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="mailto:info@party-up.be" className="hover:text-white transition-colors">
                  info@party-up.be
                </a>
              </li>
              <li className="mt-4">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Power Up BV. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
